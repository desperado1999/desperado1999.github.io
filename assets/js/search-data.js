...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-one-paper-get-conditionally-accepted-in-mobisys-25-acceptance-rate-18-0-42-233",
          title: 'One paper get conditionally accepted in MobiSys’25 (Acceptance Rate: 18.0%, 42/233)',
          description: "",
